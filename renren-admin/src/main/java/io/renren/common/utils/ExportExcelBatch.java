...
public class ExportExcelBatch {
	...
	public final static String exportExcelToResponse(HttpServletResponse response, String fileName, String[] Title,
			List<Map<String, Object>> list, BigDecimal initialBalance,BigDecimal endingBalance,String userName,Map<String, Object> params) {
		String result = "系统提示：Excel文件导出成功！";
